...
app.get('/artista/lst', async (req, res) => {
    ...
    res.render("artista/lst", { artista: artistas });
})
...
app.post('/artista/add/ok', upload.single("foto"), async (req, res) => {
  ...
  await artista.create({ nome, nacionalidade, dataDeNascimento, salario, foto: req.file.buffer });
...
app.get('/site', async (req, res) => {
  ...
  res.render('site/index.ejs', {albuns, artistas});
});
